...
{
    public class Push_Dentrix_Form
    {
        ...
        public string dentrix_form_localdb_id { get; set; }
        public string dentrix_form_ehrunique_id { get; set; }
        public string dentrix_form_ehr_id { get; set; }
        public bool is_deleted { get; set; }
        public bool is_active { get; set; }
    }
    public class Push_Dentrix_FormQuestion
    {
        public string appointmentlocation { get; set; }    
        public string organization { get; set; }
        public string location { get; set; }
