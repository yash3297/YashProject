...
{
    public class PushConfigurationRoot
    {
    ...
    public class Push_ConfigurationRoot_Response
    {
    ...
    public class Push_OrganizationBO
    {
    ...
    public class Push_ServiceInstallationBO
    {
        public string AditSync { get; set; }
