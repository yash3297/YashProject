...
// Type: PW.Adapters.SoftDent.Database.Interop.SoftDentRawImports14
...
namespace Pozative
{
  internal static class SoftDentRawImports14
  {
    [DllImport("SDInterop_14.dll", EntryPoint = "InitializeDB")]
    public static extern int SDInteropInitializeDB(
      string path,
      bool loggingOn,
      string faircomServer);

    [DllImport("SDInterop_14.dll", EntryPoint = "CloseFiles")]
    public static extern void SDInteropCloseFiles();

    [DllImport("SDInterop_14.dll", EntryPoint = "SetLogging")]
    public static extern void SDInteropSetLogging(bool loggingOn);

    [DllImport("SDInterop_14.dll", EntryPoint = "GetAppointments")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "GetAppointment")]
    public static extern IntPtr SDInteropGetAppointment(string PMSRecordID);

    [DllImport("SDInterop_14.Dll", EntryPoint = "ConfirmAppointment")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "PearlGetAppointments")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "GetOperatories")]
    public static extern IntPtr SDInteropGetOperatories();

    [DllImport("SDInterop_14.dll", EntryPoint = "PearlGetAppointmentsByOperatory")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "PearlMakeAppointment")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "PearlMakeBlockedSlot")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "PearlGetNextCallListCount")]
    public static extern IntPtr SDInteropPearlGetNextCallListCount(
      string providerID,
      int count,
      string deviceKey);

    [DllImport("SDInterop_14.dll", EntryPoint = "PearlGetFirstCallListCount")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "GetPatientPerson")]
    public static extern IntPtr SDInteropGetPatientPerson(string patientID, int index);

    [DllImport("SDInterop_14.dll", EntryPoint = "SavePatientPerson")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "LinkLookupGuarantor")]
    public static extern IntPtr SDInteropLinkLookupGuarantor(
      string xmlGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14.dll", EntryPoint = "LinkAddGuarantor")]
    public static extern IntPtr SDInteropLinkAddGuarantor(
      string xmGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14.dll", EntryPoint = "LinkUpdateGuarantor")]
    ...
    [DllImport("SDInterop_14.dll", EntryPoint = "GetPatientMedicalAlert")]
    public static extern IntPtr SDInteropGetPatientMedicalAlert(string patientID);

    [DllImport("SDInterop_14.dll", EntryPoint = "KioskCheckIn")]
    public static extern bool SDInteropKioskCheckIn(string appointmentID);

    [DllImport("SDInterop_14.dll", EntryPoint = "SetAdapterVersion")]
