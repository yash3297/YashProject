...
// Type: PW.Adapters.SoftDent.Database.Interop.SoftDentRawImports14_2
...
namespace Pozative
{
  internal static class SoftDentRawImports14_2
  {
    [DllImport("SDInterop_14_2.dll", EntryPoint = "InitializeDB")]
    public static extern int SDInteropInitializeDB(
      string path,
      bool loggingOn,
      string faircomServer);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "CloseFiles")]
    public static extern void SDInteropCloseFiles();

    [DllImport("SDInterop_14_2.dll", EntryPoint = "SetLogging")]
    public static extern void SDInteropSetLogging(bool loggingOn);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetAppointments")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetAppointment")]
    public static extern IntPtr SDInteropGetAppointment(string PMSRecordID);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "ConfirmAppointment")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetOffice")]
    public static extern IntPtr SDInteropGetOffice(string dateTime);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "SavePatient")]
    public static extern void SDInteropSavePatient(string xml);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "SaveAppointment")]
    public static extern void SDInteropSaveAppointment(string xml);

      
    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetPatient")]
    public static extern IntPtr SDInteropGetPatient(string recordID);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "CreateRestorativeChartImage")]
    public static extern IntPtr SDInteropCreateRestorativeChartImage(
      string PMSRecordID,
      int view,
      int mode);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "CreatePerioChartImage")]
    public static extern IntPtr SDInteropCreatePerioChartImage(
      string PMSRecordID,
      int view,
      int mode);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetPatientDentalInsurancePlan")]
    public static extern IntPtr SDInteropGetPatientDentalInsurancePlan(
      string PMSRecordID,
      bool primary);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetPatientDentalInsurance")]
    public static extern IntPtr SDInteropGetPatientDentalInsurance(
      string PMSRecordID,
      bool primary);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetPatientGuarantors")]
    public static extern IntPtr SDInteropGetPatientGuarantors(string PMSRecordID);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetImages")]
    public static extern IntPtr SDInteropGetImages(string PMSRecordID);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "SavePatientInsurance")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "PearlGetAppointments")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetOperatories")]
    public static extern IntPtr SDInteropGetOperatories();

    [DllImport("SDInterop_14_2.dll", EntryPoint = "PearlGetAppointmentsByOperatory")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "PearlMakeAppointment")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "PearlMakeBlockedSlot")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "PearlGetNextCallListCount")]
    public static extern IntPtr SDInteropPearlGetNextCallListCount(
      string providerID,
      int count,
      string deviceKey);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "PearlGetFirstCallListCount")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetPatientPerson")]
    public static extern IntPtr SDInteropGetPatientPerson(string patientID, int index);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "SavePatientPerson")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "LinkLookupGuarantor")]
    public static extern IntPtr SDInteropLinkLookupGuarantor(
      string xmlGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "LinkAddGuarantor")]
    public static extern IntPtr SDInteropLinkAddGuarantor(
      string xmGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "LinkUpdateGuarantor")]
    ...
    [DllImport("SDInterop_14_2.dll", EntryPoint = "GetPatientMedicalAlert")]
    public static extern IntPtr SDInteropGetPatientMedicalAlert(string patientID);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "KioskCheckIn")]
    public static extern bool SDInteropKioskCheckIn(string appointmentID);

    [DllImport("SDInterop_14_2.dll", EntryPoint = "SetAdapterVersion")]
