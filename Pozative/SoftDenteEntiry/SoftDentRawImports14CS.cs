...
// Type: PW.Adapters.SoftDent.Database.Interop.SoftDentRawImports14CS
...
namespace Pozative
{
  internal static class SoftDentRawImports14CS
  {
    [DllImport("SDInterop_14CS.Dll", EntryPoint = "InitializeDB")]
    public static extern int SDInteropInitializeDB(
      string path,
      bool loggingOn,
      string faircomServer);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "CloseFiles")]
    public static extern void SDInteropCloseFiles();

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "SetLogging")]
    public static extern void SDInteropSetLogging(bool loggingOn);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetAppointments")]
    ...
    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetAppointment")]
    public static extern IntPtr SDInteropGetAppointment(string PMSRecordID);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "ConfirmAppointment")]
    ...
    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetOffice")]
    public static extern IntPtr SDInteropGetOffice(string dateTime);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "SavePatient")]
    public static extern void SDInteropSavePatient(string xml);


     [DllImport("SDInterop_14CS.Dll", EntryPoint = "SaveAppointment")]
    public static extern void SDInteropSaveAppointment(string xml);
    

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetPatient")]
    public static extern IntPtr SDInteropGetPatient(string recordID);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "CreateRestorativeChartImage")]
    public static extern IntPtr SDInteropCreateRestorativeChartImage(
      string PMSRecordID,
      int view,
      int mode);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "CreatePerioChartImage")]
    public static extern IntPtr SDInteropCreatePerioChartImage(
      string PMSRecordID,
      int view,
      int mode);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetPatientDentalInsurancePlan")]
    public static extern IntPtr SDInteropGetPatientDentalInsurancePlan(
      string PMSRecordID,
      bool primary);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetPatientDentalInsurance")]
    public static extern IntPtr SDInteropGetPatientDentalInsurance(
      string PMSRecordID,
      bool primary);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetPatientGuarantors")]
    public static extern IntPtr SDInteropGetPatientGuarantors(string PMSRecordID);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "GetImages")]
    public static extern IntPtr SDInteropGetImages(string PMSRecordID);

    [DllImport("SDInterop_14CS.Dll", EntryPoint = "SavePatientInsurance")]
    ...
    [DllImport("SDInterop_14CS.Dll", EntryPoint = "PearlGetAppointments")]
    ...
    [DllImport("SDInterop_14CS.dll", EntryPoint = "GetOperatories")]
    public static extern IntPtr SDInteropGetOperatories();

    [DllImport("SDInterop_14CS.dll", EntryPoint = "PearlGetAppointmentsByOperatory")]
    ...
    [DllImport("SDInterop_14CS.dll", EntryPoint = "PearlMakeAppointment")]
    ...
    [DllImport("SDInterop_14CS.dll", EntryPoint = "PearlMakeBlockedSlot")]
    ...
    [DllImport("SDInterop_14CS.dll", EntryPoint = "PearlGetNextCallListCount")]
    public static extern IntPtr SDInteropPearlGetNextCallListCount(
      string providerID,
      int count,
      string deviceKey);

    [DllImport("SDInterop_14CS.dll", EntryPoint = "PearlGetFirstCallListCount")]
    ...
    [DllImport("SDInterop_14CS.dll", EntryPoint = "GetPatientPerson")]
    public static extern IntPtr SDInteropGetPatientPerson(string patientID, int index);

    [DllImport("SDInterop_14CS.dll", EntryPoint = "SavePatientPerson")]
    ...
    [DllImport("SDInterop_14CS.dll", EntryPoint = "LinkLookupGuarantor")]
    public static extern IntPtr SDInteropLinkLookupGuarantor(
      string xmlGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14CS.dll", EntryPoint = "LinkAddGuarantor")]
    public static extern IntPtr SDInteropLinkAddGuarantor(
      string xmGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14CS.dll", EntryPoint = "LinkUpdateGuarantor")]
    ...
    [DllImport("SDInterop_14CS.dll", EntryPoint = "GetPatientMedicalAlert")]
    public static extern IntPtr SDInteropGetPatientMedicalAlert(string patientID);

    [DllImport("SDInterop_14CS.dll", EntryPoint = "KioskCheckIn")]
    public static extern bool SDInteropKioskCheckIn(string appointmentID);

    [DllImport("SDInterop_14CS.dll", EntryPoint = "SetAdapterVersion")]
