...
// Type: PW.Adapters.SoftDent.Database.Interop.SoftDentRawImports14_2CS
...
namespace Pozative
{
  internal static class SoftDentRawImports14_2CS
  {
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "InitializeDB")]
    public static extern int SDInteropInitializeDB(
      string path,
      bool loggingOn,
      string faircomServer);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "CloseFiles")]
    public static extern void SDInteropCloseFiles();

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "SetLogging")]
    public static extern void SDInteropSetLogging(bool loggingOn);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetAppointments")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetAppointment")]
    public static extern IntPtr SDInteropGetAppointment(string PMSRecordID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "ConfirmAppointment")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetOffice")]
    public static extern IntPtr SDInteropGetOffice(string dateTime);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "SavePatient")]
    public static extern void SDInteropSavePatient(string xml);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "SaveAppointment")]
    public static extern void SDInteropSaveAppointment(string xml);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPatient")]
    public static extern IntPtr SDInteropGetPatient(string recordID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "CreateRestorativeChartImage")]
    public static extern IntPtr SDInteropCreateRestorativeChartImage(
      string PMSRecordID,
      int view,
      int mode);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "CreatePerioChartImage")]
    public static extern IntPtr SDInteropCreatePerioChartImage(
      string PMSRecordID,
      int view,
      int mode);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPatientDentalInsurancePlan")]
    public static extern IntPtr SDInteropGetPatientDentalInsurancePlan(
      string PMSRecordID,
      bool primary);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPatientDentalInsurance")]
    public static extern IntPtr SDInteropGetPatientDentalInsurance(
      string PMSRecordID,
      bool primary);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPatientGuarantors")]
    public static extern IntPtr SDInteropGetPatientGuarantors(string PMSRecordID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetImages")]
    public static extern IntPtr SDInteropGetImages(string PMSRecordID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "SavePatientInsurance")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "PearlGetAppointments")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetOperatories")]
    public static extern IntPtr SDInteropGetOperatories();

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "PearlGetAppointmentsByOperatory")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "PearlMakeAppointment")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "PearlMakeBlockedSlot")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "PearlGetNextCallListCount")]
    public static extern IntPtr SDInteropPearlGetNextCallListCount(
      string providerID,
      int count,
      string deviceKey);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "PearlGetFirstCallListCount")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPatientPerson")]
    public static extern IntPtr SDInteropGetPatientPerson(string patientID, int index);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "SavePatientPerson")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "CheckForMidnight")]
    public static extern void SDInteropCheckForMidnight();

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetEFormPathAndName")]
    public static extern IntPtr SDInteropGetEFormPathAndName(string patientID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetFirstPharmacyListCount")]
    public static extern IntPtr SDInteropGetFirstPharmacyListCount(
      int count,
      string deviceKey);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetNextPharmacyListCount")]
    public static extern IntPtr SDInteropGetNextPharmacyListCount(int count, string deviceKey);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPatientSpouse")]
    public static extern IntPtr SDInteropGetPatientSpouse(string patientID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "SavePatientSpouse")]
    public static extern bool SDInteropSavePatientSpouse(string patientID, string spouse);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetFirstSDClinicalNotes")]
    public static extern IntPtr SDInteropGetFirstSDClinicalNotes(
      string patientID,
      int count,
      string deviceKey);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetNextSDClinicalNotes")]
    public static extern IntPtr SDInteropGetNextSDClinicalNotes(
      string patientID,
      int count,
      string deviceKey);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPreviousSDClinicalNotes")]
    public static extern IntPtr SDInteropGetPreviousSDClinicalNotes(
      string patientID,
      int count,
      string deviceKey);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "MakeClinicalNote")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "LinkLookupGuarantor")]
    public static extern IntPtr SDInteropLinkLookupGuarantor(
      string xmlGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "LinkAddGuarantor")]
    public static extern IntPtr SDInteropLinkAddGuarantor(
      string xmGuarantor,
      string xmlSource);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "LinkUpdateGuarantor")]
    ...
    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "GetPatientMedicalAlert")]
    public static extern IntPtr SDInteropGetPatientMedicalAlert(string patientID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "KioskCheckIn")]
    public static extern bool SDInteropKioskCheckIn(string appointmentID);

    [DllImport("SDInterop_14_2CS.dll", EntryPoint = "SetAdapterVersion")]
